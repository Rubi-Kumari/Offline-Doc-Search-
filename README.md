...
Key Highlights:  
 ...
 Semantic Search: Goes beyond keyword matching to understand meaning and context in your queries.  
 
 Multi-Format Document Support: Upload and index PDFs, Word files, and text documents.  
 
 Instant Q&A: Ask natural-language questions and get precise answers extracted directly from your documents.  
 
 Embeddings + LLMs: Combines vector search (semantic retrieval) with local LLM reasoning for intelligent answers.
